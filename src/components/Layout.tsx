...
function FloatingWhatsApp() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-[9999] grid h-14 w-14 place-items-center rounded-full bg-whatsapp text-white shadow-[var(--shadow-card-hover)] animate-wa-pulse transition hover:scale-110"
      style={{ zIndex: 9999 }}
    >
      ...
      <span className="pointer-events-none absolute right-full mr-3 whitespace-nowrap rounded-lg bg-navy px-3 py-1.5 text-xs font-medium text-white opacity-0 transition group-hover:opacity-100">Chat with us on WhatsApp</span>
    </a>
  );
}
